...
require_once SAB_PLUGIN_DIR . 'includes/class-seo-detector.php';
require_once SAB_PLUGIN_DIR . 'includes/class-exporter.php';
...
if ( is_admin() ) {
	...
	require_once SAB_PLUGIN_DIR . 'admin/class-export-admin.php';
}
